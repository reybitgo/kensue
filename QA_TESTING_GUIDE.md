# NetPro MLM Binary System — QA Testing Guide
...
| Member 1 (Sponsor) | `member1` | `Test@1234` | *(from admin)* |
| Member 2 (Left of Member 1) | `member2` | `Test@1234` | *(from admin)* |
| Member 3 (Right of Member 1) | `member3` | `Test@1234` | *(from admin)* |
| Member 4 (Left of Member 2) | `member4` | `Test@1234` | *(from admin)* |
| Member 5 (Right of Member 2) | `member5` | `Test@1234` | *(from admin)* |
...
|---|------|----------------|--------|
| 1 | Go to `http://localhost/kensue/` | Browser redirects to `/?page=login` | [ ] |
| 2 | Look at the page title in the browser tab | Shows **"Login — NetPro MLM"** | [ ] |
| 3 | Check the favicon in the browser tab | Green hexagon logo is visible | [ ] |
| 4 | Check the top of the login card | Kensue logo image is visible | [ ] |
| 5 | Check the card heading | Shows **"NetPro MLM"** | [ ] |
| 6 | Check the subtext | Shows **"Build Your Network. Grow Your Income."** | [ ] |
| 7 | Check the form fields | Username field and Password field are visible | [ ] |
| 8 | Check the button | **"Sign In"** button is visible | [ ] |
| 9 | Check the footer link | **"Register with a code →"** link is visible | [ ] |
...
| 6 | Check the page title | Shows **"Admin Dashboard — NetPro MLM"** | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Note member1's current balance (check `/?page=admin_user_view&id=X`) | Record: ₱______ | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Change **Site Name** to `Kensue MLM` | — | [ ] |
| 2 | Change **Minimum Payout** to `1000` | — | [ ] |
| 3 | Click **💾 Save Settings** | Flash: **"Settings saved."** | [ ] |
| 4 | Refresh the page | Site Name shows `Kensue MLM`, Min Payout shows `1000` | [ ] |
| 5 | Go to login page | Page title now shows **"Login — Kensue MLM"** | [ ] |
| 6 | Revert site name to `NetPro MLM` and min payout to `500` | Flash: **"Settings saved."** | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Note member1's `pairs_paid_today` value (from user view) | Record: ______ | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Log in as `member1` in one tab | Note current balance: ₱______ | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Note admin's e-wallet balance | ₱______ | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Check member1's balance before | ₱______ | [ ] |
...
| # | Step | Expected Result | Status |
|---|------|----------------|--------|
| 1 | Note a code that was already used (status = "used" in admin) | Record: ____________ | [ ] |
...
*QA Testing Guide — NetPro MLM Binary System v1.0*
*Total Test Cases: 78 across 17 sections*
